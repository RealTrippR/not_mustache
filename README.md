...
Not-mustache is a near-identical derivative of the mustache templating language, and is backwards compatible with most mustache templates. It adds array indexing and length functions, has a shortened syntax, and handles standalone lines differently.

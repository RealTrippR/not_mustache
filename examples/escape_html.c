const char* TEMPLATE =
"* * HTML ESCAPE EXAMPLE * *\n"
"By default, not-mustache escapes html within string parameters.\n"
"Any string that immediately preceded by the '&' symbol will render as raw html.\n"
"\nFor Example, raw html:\n"
"/{{&some_html}}: \n"
"{{&some_html}}\n"

"For example, escaped html:\n"
"/{{some_html}}: \n"
"{{some_html}}\n"
"";
